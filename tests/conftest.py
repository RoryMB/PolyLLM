...
OPENAI_MODEL = os.getenv("TEST_OPENAI_MODEL", "gpt-4o")
GOOGLE_MODEL = os.getenv("TEST_GOOGLE_MODEL", "gemini-1.5-flash-latest")
ANTHROPIC_MODEL = os.getenv("TEST_ANTHROPIC_MODEL", "claude-3-5-sonnet-latest")
